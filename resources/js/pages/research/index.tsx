                ...
                <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
                    ...
                    <div>
                        ...
                        <div className="mb-6">
                            <div className="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        Capture and organize your research. AI analyzes everything for easy retrieval.
                                    </p>
                                </div>
                            </div>
                            ...
                            {/* Feature Badges */}
                            <div className="mt-4">
                                <FeatureBadgeGroup features={['vector-store', 'vision']} />
                            </div>
                        </div>
                        ...
                        {items.data.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border/50 bg-muted/20 py-16 text-center">
                                ...
                                <h3 className="mt-4 text-lg font-semibold text-foreground">No research items yet</h3>
                    ...
                    <div className="lg:sticky lg:top-6 lg:self-start">
                        <div className="mb-4 flex items-center justify-between">
                            <h2 className="text-lg font-semibold text-foreground">Capture Content</h2>
                        </div>
                        ...
                        <div className="mb-4 rounded-lg border border-border/50 bg-muted/20 p-4">
                            ...
                            <ol className="mt-2 space-y-2 text-sm text-muted-foreground">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>Upload an image, document, or paste a URL</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="flex size-5 shrink-0 items-center justify-center rounded-full bg-violet-500/20 text-xs font-medium text-violet-600 dark:text-violet-400">
                                        2
                                    ...
                                    <span>
                                        ...
                                        <FeatureBadge feature="vision" showLabel={false} className="inline-flex" />
                                    </span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="flex size-5 shrink-0 items-center justify-center rounded-full bg-violet-500/20 text-xs font-medium text-violet-600 dark:text-violet-400">
                                    ...
                                    <span>
                                        Stored in{' '}
                                        <FeatureBadge feature="vector-store" showLabel={false} className="inline-flex" />{' '}
                                        for semantic search
                                    </span>
                                </li>
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>
                                        ...
                                        <FeatureBadge feature="file-search" showLabel={false} className="inline-flex" />
                                    </span>
                                </li>
                            </ol>
                        </div>
