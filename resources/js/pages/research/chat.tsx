...
const toolMeta: Record<string, { icon: typeof Search; label: string }> = {
    file_search: { icon: Search, label: 'Knowledge Base' },
...
const suggestionPool = [
    ...
    'Compare my saved articles',
    'What did I save recently?',
    'Find research about machine learning',
    'What are the main takeaways?',
    'Show me everything about web development',
    'What patterns emerge across my notes?',
    'Summarize the most important findings',
    'What topics do I research most?',
];

function useRotatingSuggestions(groupSize = 3, intervalMs = 6000) {
...
export default function ResearchChat() {
    ...
    return (
        <AppLayout>
            <Head title={currentTitle ? `${currentTitle} - Chat` : 'Chat'} />
                        ...
                        {localMessages.length === 0 && !isStreaming ? (
                            <div className="flex h-full flex-col items-center justify-center text-center">
                                ...
                                <p className="mt-2 max-w-sm text-muted-foreground">
                                    ...
                                    I'll search your knowledge base and the web.
                                </p>
                                <div
